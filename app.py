...
if voice_mode and use_voice and st.button("🎤 Listen - Speak Now"):
    st.info("🎤 Listening... Speak now (make sure your microphone is allowed)")
    ...
    # Hidden input to capture voice result (this is a simple workaround for Streamlit)
    user_input = st.text_input("Voice Input", key="voice-input", label_visibility="collapsed")
