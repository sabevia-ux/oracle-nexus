...
Answer naturally and refer to memories when relevant."""
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            # Voice Output - Using reliable voice IDs
            if use_voice and ELEVENLABS_API_KEY:
                try:
                    voice_map = {
                        "Adam - Warm & Deep (Recommended)": "pNInz6obpgDQGcFmaJgB",
                        "Rachel - Natural Female": "21m00Tcm4TlvDq8ikWAM",
                        "Josh - Energetic Male": "TxGEqnHWrfWFTfGW9XjX",
                        "Bella - Warm Female": "21m00Tcm4TlvDq8ikWAM",
                        "Ryan - British Male": "en-GB-RyanNeural",
                        "Drew - Calm Male": "AZnzlk1XvdvUeBnXmlld",
                        "Ellie - Friendly Female": "EXAVITQu4vr4xnSDxMaL",
                        "Cassidy - Natural Female": "21m00Tcm4TlvDq8ikWAM"
                    }
                    voice_id = voice_map.get(voice_style, "pNInz6obpgDQGcFma