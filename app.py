...
OPENAI_API_KEY = st.secrets.get("OPENAI_API_KEY")   # For ChatGPT
...
openai_client = OpenAI(api_key=OPENAI_API_KEY)   # ChatGPT client
...
st.caption("Your personal multi-persona AI with long-term memory + Natural Voice")
        ...
        with st.spinner("Thinking..."):
            if llm_choice == "Grok":
                ...
                if not OPENAI_API_KEY:
                    reply = "OpenAI API key not configured in secrets."
                else:
