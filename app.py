...
grok_client = OpenAI(base_url="https://api.x.ai/v1", api_key=os.getenv("XAI_API_KEY"))
        ...
        with st.spinner("Thinking..."):
            if llm_choice == "Grok":
                ...
                if not google_api_key:
                    reply = "Gemini API key is not configured. Please add GOOGLE_API_KEY in secrets."
                else:
