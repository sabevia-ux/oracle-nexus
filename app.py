...
if prompt := st.chat_input("Type your message..."):
    ...
    # Strong verification instructions
    verification_instructions = """
CRITICAL VERIFICATION RULES:
- Double-check all facts before answering.
- Never guess, assume, or make up information.
- For any location, ZIP code, date, number, or specific detail — verify carefully.
- If you are not 100% sure, say "I don't know" or "I need to verify this".
- Think step by step and be honest about uncertainty.
"""
        ...
        with st.spinner("Thinking and verifying..."):
            if llm_choice == "Grok":
                response = grok_client.chat.completions.create(
                    model="grok-4-1-fast-reasoning", messages=messages, temperature=0.3, max_tokens=1000)
